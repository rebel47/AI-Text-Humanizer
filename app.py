...
def humanize_text(text, tone="neutral"):
    ...
    """
    prompt = f"Ae chikne sun wo na jo text {text} de raha hun usko manushya ki bhasha mein parivartan kripya kar kare, mere ko thesis krni hai to matlab koi ai software pakad na sake aisa krdo. KRDO PLEASE KRDO!! tumhe tumhari mummy kasam. or tone aisa krdo {tone} or isko ENGLISH mein hi de bhai"
